(function(h, o, g) {
    ...
    g[h] = {
        ...
        settings: {
            ...
            loop: false,
            preload: true,
            imageLocation: p + "player-icons.png",
            ...
            createPlayer: {
                markup: '<div class="controls"><div class="leftControls"><button class="play-pause" aria-label="Botão de Play / Pause"><span class="play"></span><span class="pause"></span><span class="loading"></span><span class="error"></span></button></div><div class="rightControls"><div class="scrubber" tabindex="-1" aria-hidden="true"><div class="total"></div><div class="progress"></div><div class="loaded"></div></div><div class="lineControls"><p class="time"><span class="leitorTela">Tempo do podcast:</span><span class="played">00:00</span>/<span class="duration">00:00</span></p><div class="volume"><div class="btn-volume"><i class="ico-volumeMin" aria-hidden="true"></i></div><input class="volumebarra" id="volumeBar_0" type="range" value="70" min="0" max="100" step="5" aria-label="Controle de Volume: 70" aria-valuemin="0" aria-valuemax="100" tabindex="0" data-rangeid="0"></div><div class="download"><a class="btn-download"></a></div><div class="transcricao"><a class="btn-transcricao"></a></div></div></div></div><div class="error-message"></div>',
